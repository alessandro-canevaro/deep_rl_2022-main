...
class A3C(Algorithm):
    ...
    def log_result(self, result):
        return super().log_result(result)
    ...
    def training_step(self) -> ResultDict:
        ...
        x = learner_info_builder.finalize()
        # now we do stuff!
        #
        if 'default_policy' in x:
            stats = x['default_policy']['learner_stats']
            # print("> training_step. Has learer policy. ", stats)
        else:
            pass
            # print("> training_step. No policy.")
            # self.wandb.log(stats) # snitches get stitches.
        # print("training_step(..)")
        # if 'learner' in result['info']:
        #     print("This one had a learner")
